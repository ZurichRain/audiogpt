...
from Audiogpt_dev.train.trainer import AudioGPTTrainer
...
from Audiogpt_dev.data.AudioDatacollector import DataCollatorForSupervisedDataset
from Audiogpt_dev.config.configs import dataConfig

from Audiogpt_dev.model.AudiogptBase import *
from Audiogpt_dev.data.AudioDataset import AudioDataset
import random
...
def train():
    ...
    if model_config.freeze_lm_model:
        ...
        for p in model.audio_decoder_projector_layer.parameters():
            p.requires_grad = True
    ...
    # audio_decoder_projector_layer.weight
